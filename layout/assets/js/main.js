(function ($) {
    ...
    $(function() {
        ...
        $("#slider-range").on("slidestop", function(event, ui) { 
            ...
            window.location.href = "index.php?pg=sanpham&minPrice=" + minPrice + "&maxPrice=" + maxPrice;
        });
    
        // Khởi tạo giá trị ban đầu cho input amount
        $("#amount").val($("#slider-range").slider("values", 0).toLocaleString('vi-VN') + " VNĐ - " + $("#slider-range").slider("values", 1).toLocaleString('vi-VN') + " VNĐ");
    });
